...
<div class="content-wrapper">
    ...
    <div class="card-header">
        <td>
            <a href="{{route('admin.rumah.create')}}" class="btn btn-outline-primary">
                <span><i class="feather icon-plus"></i> Tambah Marker</span>
            </a>
        </td>
    </div>
    <!-- Main content -->
            ...
            <div class="col-12">
                <div class="info-box">
                    <div class="info-box-content">
                        {{-- <h2 class="info-box-text">TEXT</h2>
...
<script>
    ...
    // });
    //for custom marker
    // L.marker([-3.4458,114.8214], {icon: greenIcon}).addTo(map);
